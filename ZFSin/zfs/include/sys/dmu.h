...
void byteswap_uint64_array(void *buf, uint32_t size);
void byteswap_uint32_array(void *buf, uint32_t size);
void byteswap_uint16_array(void *buf, uint32_t size);
void byteswap_uint8_array(void *buf, uint32_t size);
void zap_byteswap(void *buf, uint32_t size);
void zfs_oldacl_byteswap(void *buf, uint32_t size);
void zfs_acl_byteswap(void *buf, uint32_t size);
void zfs_znode_byteswap(void *buf, uint32_t size);
...
int dmu_objset_find(char *name, int func(const char *, void *), void *arg,
    int flags);
void dmu_objset_byteswap(void *buf, uint32_t size);
...
typedef struct dmu_object_info {
    ...
    typedef void arc_byteswap_func_t(void *buf, uint32_t size);
