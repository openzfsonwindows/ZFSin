...
while ((i < 5)); do
	...
	log_must $MKFILE $MKFILE_SPARSE 16M $mntpnt/file$i
	log_must $MKFILE $MKFILE_SPARSE "$r_size"M $mntpnt/file_var$i
	...
	log_must $MKFILE $MKFILE_SPARSE 16M $mntpnt_cln/file_cln$i
	log_must $MKFILE $MKFILE_SPARSE "$r_size"M $mntpnt_cln/file_cln_var$i
