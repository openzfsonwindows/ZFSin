...
typeset checksum=$(md5 /$TESTPOOL/$TESTFS2/$TESTFILE0 | awk '{ print $1 }')
...
typeset cksum1=$(md5 /$TESTPOOL/$TESTFS1/c1/$TESTFILE0 | awk '{ print $1 }')
[[ "$cksum1" == "$checksum" ]] || \
...
typeset cksum2=$(md5 /$TESTPOOL/$TESTFS2/c1/$TESTFILE0 | awk '{ print $1 }')
[[ "$cksum2" == "$checksum" ]] || \
