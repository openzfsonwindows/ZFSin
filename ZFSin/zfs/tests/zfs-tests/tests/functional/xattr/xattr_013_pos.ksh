...
log_mustnot eval "xattr -p passwd $TESTDIR/myfile.$$ > /dev/null 2>&1"
#log_mustnot eval "$RUNAT $TESTDIR/myfile.$$ $RM passwd > /dev/null 2>&1"
log_mustnot eval "xattr -d passwd $TESTDIR/myfile.$$ > /dev/null 2>&1"
#log_mustnot eval "$RUNAT $TESTDIR/myfile.$$ $CP /etc/passwd . > /dev/null 2>&1"
log_mustnot eval "xattr -w test value $TESTDIR/myfile.$$ > /dev/null 2>&1"

log_must $TOUCH $TESTDIR/new.$$
#log_mustnot eval "$RUNAT $TESTDIR/new.$$ $CP /etc/passwd . > /dev/null 2>&1"
log_mustnot eval "xattr -w test value $TESTDIR/new.$$ > /dev/null 2>&1"
#log_mustnot eval "$RUNAT $TESTDIR/new.$$ $RM passwd > /dev/null 2>&1"
log_mustnot eval "xattr -d test $TESTDIR/new.$$ > /dev/null 2>&1"
...
log_mustnot eval "xattr -p passwd $TESTDIR/new.$$ > /dev/null 2>&1"
