...
log_mustnot $DD if=/dev/zero bs=1048576 count=11 of=$mntpnt/file
#log_must $MKFILE 9M $mntpnt/file
log_must $DD if=/dev/zero bs=1048576 count=9 of=$mntpnt/file
log_must $ZFS snapshot $fs@snap
#log_mustnot $MKFILE 2M $mntpnt/file2
log_mustnot $DD if=/dev/zero bs=1048576 count=2 of=$mntpnt/file2
