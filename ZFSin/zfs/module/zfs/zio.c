...
static __forceinline void zio_taskq_dispatch(zio_t *, zio_taskq_type_t, boolean_t);
static __forceinline void __zio_execute(zio_t *zio);
static __forceinline void zio_reexecute(zio_t *pio);
 ...
 */
extern  zio_pipe_stage_t *zio_pipeline[];
